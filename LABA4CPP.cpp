 ...
 public:
  Circle(double r) {
    if (r > 0) {
      ...
      radius = 1;
      cout << "Радиус должен быть положительным. Установлено значение 1."
           << endl;
    }
  }
 ...
 public:
  Cone(double r, double h) : Circle(r) {
    if (h > 0) {
      ...
      height = 1;
      cout << "Высота должна быть положительной. Установлено значение 1."
           << endl;
    }
  }
...
int main() {
  ...
  while (innerRadius >= outerRadius) {
    cout << "Внутренний радиус должен быть меньше внешнего! Попробуйте снова."
         << endl;
